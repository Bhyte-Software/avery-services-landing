...
const buttonBase =
  "group/button cursor-pointer inline-flex shrink-0 items-center justify-center rounded-lg font-sans font-medium text-sm normal-case whitespace-nowrap transition-all outline-none select-none focus-visible:ring-2 focus-visible:ring-[#087443]/30 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 h-8 gap-1.5 px-4"
...
export const consentProviderOptions: Omit<
...
export const consentDialogTheme = {
  "dialog.root": {
    style: {
      "--dialog-height": "100%",
  ...
  "dialog.title": {
    noStyle: true,
    className: "text-base font-medium leading-none tracking-tight text-foreground",
  },
  "dialog.description": {
    noStyle: true,
    className: "text-sm leading-relaxed text-muted-foreground",
  ...
  "dialog.footer": {
    style: {
      ...
      "--dialog-branding-focus-color": "color-mix(in oklab, #087443 50%, transparent)",
      "--dialog-branding-focus-color-dark": "color-mix(in oklab, #087443 50%, transparent)",
