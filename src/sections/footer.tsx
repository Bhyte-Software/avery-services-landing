    ...
    return (
        <>
            ...
            <footer className='z-50 max-w-screen overflow-x-hidden bg-background px-2 pb-2 border-t border-edge'>
                ...
                >
                    <span className=" text-sm text-foreground font-mono uppercase">© 2026 Culio. All Rights reserved.</span>
                    <span className=" text-sm text-foreground font-mono uppercase">A Bhyte Software Company</span>
                </div>
            </footer>
        </>
    )
